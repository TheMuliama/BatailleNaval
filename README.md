...
- [x] Le résultat des tirs sur le plateau depuis le serveur
- [x] Envoyer les inputs de l'utilisateur au serveur
- [x] Laisser le client le choix du serveur (Choix de l'addresse IP et du PORT)
...
**Code serveur**
- [x] Initialisation de chaque nouvelle partie
- [x] Stocker les informations du plateau
- [x] Recevoir les input d'une client et mettre à jour le plateau
- [ ] Afficher une vue complète de toute la partie
- [x] Envoyer les résultats des tirs de l'utilisateur au client
